...
byte ccpCalBuffer[256]@0x3C00={
0x01,0x01,0x00,0x0F,0xA0,
0x15,0x7C,0x0B,0xB8,0x07,
0xD0,0x00,0x00,0x01,0x2C,
0x02,0x58,0x03,0x52,0x03,
0x20,0x01,0x2C,0x00,0xB4
};       //定义ccp标定的Buffer共256个字节
